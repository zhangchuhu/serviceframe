#ifndef _TINYXML_DBCONFIG_H_FXW_
#define _TINYXML_DBCONFIG_H_FXW_
#include <string>
#include <vector>
...
namespace server{
	namespace config{
		class TinyXmlDbConfigImp: public virtual IDatabaseConfig, public WatchHelper<IDbConfigWatchBase, IDbConfigWatcher>{
		public:
			TinyXmlDbConfigImp();
		...
		class TinyXmlDbOraConfigImp: public virtual IDatabaseConfig, public WatchHelper<IDbConfigWatchBase, IDbConfigWatcher>{
		public:
			TinyXmlDbOraConfigImp();
			//for mysql
