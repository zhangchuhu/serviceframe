#ifndef _TINYXML_HA_DBCIPHERCONFIG_H_FXW_
#define _TINYXML_HA_DBCIPHERCONFIG_H_FXW_
...
namespace server{
	namespace config{
		class TinyXmlHADbCipherConfigImp: public virtual IDatabaseConfig2, public WatchHelper<IDbConfigWatchBase, IDbConfigWatcher>{
		public:
			TinyXmlHADbCipherConfigImp();
