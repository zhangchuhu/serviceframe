#ifndef HANDLERSOCKET_MAIN_INC_H_
#define HANDLERSOCKET_MAIN_INC_H_
...
#include "server_common/handlersocket_lib/HandlerSocketHelperTempalte.h"
#include "server_common/handlersocket_lib/HandlerSocketConnCreator.h"


using namespace server::config;
using namespace server::mysqldb4hs;
using namespace server::mysqldb;
using namespace server::db;

#define CONFIG_MYSQLDAEMON_SERVER_INIT_HS(ConfigName, AppCtxClz, ConnManagerClz, SConnCreatorClz, CConnCreatorClz, LinkHandlerClz, SqlFacClz, ConfigClz, DBConfigClz)  \
	\
	...
	HandlerSocketHelperTempalte __mysql_hs_Helper; \
	...
	\
	__mysql_hs_Helper.setHandlerSocketConnFactory(&__sqlFactory); \
	\
	...
	HandlerSocketConnCreator __mysql_hs_Creator;\
	\
	__sqlFactory.setConnectionCreator(&__mysql_hs_Creator); \
