...
#define CONFIG_RDAEMON_SERVER_INIT3(XmlConfigFile, ConfigName, AppCtxClz, ConnManagerClz, SConnCreatorClz, CConnCreatorClz, LinkHandlerClz, WriterClz, ConfigClz)  \
	\
	...
	server::config::LoaderContainer __loader(XmlConfigFile); \
	\
